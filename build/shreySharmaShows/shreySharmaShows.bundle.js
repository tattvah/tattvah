...
/***/ "./shrey-sharma-shows/shreySharmaShows.scss":
/*!**************************************************!*\
  !*** ./shrey-sharma-shows/shreySharmaShows.scss ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
/*!************************************************!*\
  !*** ./shrey-sharma-shows/shreySharmaShows.js ***!
  \************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _shreySharmaShows_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shreySharmaShows.scss */ "./shrey-sharma-shows/shreySharmaShows.scss");
...
for (let index = 0; index < tabs.length; index++) {
  ...
  tabs_element.addEventListener('click', function (e) {
    ...
    let add_active = document.querySelector(".cards[data-attr='" + target.getAttribute('data-attr') + "']");
...
for (let index = 0; index < mobile_tabs.length; index++) {
  ...
  mobile_tabs_element.addEventListener('click', function (e) {
    if (e.currentTarget.classList.contains('active') == false) {
      ...
      mobile_tabs_active.children[0].innerText = e.currentTarget.innerText;
      ...
      let cards_ative = document.querySelector('.cards.active');
      cards_ative.classList.remove('active');
      let add_active = document.querySelector(".cards[data-attr='" + get_data + "']");
      add_active.classList.add('active');
      document.querySelector('.mobilenav-tabs.active').classList.remove('active');
    }
  });
}
})();
...
/******/ })()
;
//# sourceMappingURL=shreySharmaShows.bundle.js.map