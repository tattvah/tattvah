...
<head>
    ...
    <link rel="stylesheet" href='<?php echo get_theme_file_uri(\"build/ourTeam/ourTeam.css\"); ?>'>
    <script type="module" defer src='<?php echo get_theme_file_uri(\"build/ourTeam/ourTeam.bundle.js\"); ?>'></script>
    <?php
