...
<head>
    ...
    <link rel="stylesheet" href='<?php echo get_theme_file_uri(\"build/refundPolicy/refundPolicy.css\"); ?>'>
    <script type="module" defer src='<?php echo get_theme_file_uri(\"build/refundPolicy/refundPolicy.bundle.js\"); ?>'></script>
    <?php
